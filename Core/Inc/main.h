...
#define L980_LASER_PWR_ON_OUT_Pin GPIO_PIN_3
#define L980_LASER_PWR_ON_OUT_GPIO_Port GPIOC
...
#define LASER980_DAC_EN_OUT_Pin GPIO_PIN_4
#define LASER980_DAC_EN_OUT_GPIO_Port GPIOC
