...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM16_MspInit 0 */
    ...
    PB4     ------> TIM16_CH1
    */
    GPIO_InitStruct.Pin = ECODE_A_TIM16CH1_INPUT_CAPTURE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM16;
    HAL_GPIO_Init(ECODE_A_TIM16CH1_INPUT_CAPTURE_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM17_MspInit 0 */
    ...
    PB5     ------> TIM17_CH1
    */
    GPIO_InitStruct.Pin = ECODE_B_TIM17CH1_INPUT_CAPTURE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF10_TIM17;
    HAL_GPIO_Init(ECODE_B_TIM17CH1_INPUT_CAPTURE_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM3_MspPostInit 0 */
    ...
    PC6     ------> TIM3_CH1
    */
    GPIO_InitStruct.Pin = TMC_STEP_TIM3CH1_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM3;
    HAL_GPIO_Init(TMC_STEP_TIM3CH1_PWM_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM8_MspPostInit 0 */
    ...
    PC7     ------> TIM8_CH2
    */
    GPIO_InitStruct.Pin = AUXILIARY_BULB_TIM8CH2_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF4_TIM8;
    HAL_GPIO_Init(AUXILIARY_BULB_TIM8CH2_PWM_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM20_MspPostInit 0 */
    ...
    PC8     ------> TIM20_CH3
    */
    GPIO_InitStruct.Pin = TEC_DRV8701_TIM20CH2_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF6_TIM20;
    HAL_GPIO_Init(TEC_DRV8701_TIM20CH2_PWM_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM16_MspDeInit 0 */
    ...
    PB4     ------> TIM16_CH1
    */
    HAL_GPIO_DeInit(ECODE_A_TIM16CH1_INPUT_CAPTURE_GPIO_Port, ECODE_A_TIM16CH1_INPUT_CAPTURE_Pin);
  ...
  /* USER CODE END TIM17_MspDeInit 0 */
    ...
    PB5     ------> TIM17_CH1
    */
    HAL_GPIO_DeInit(ECODE_B_TIM17CH1_INPUT_CAPTURE_GPIO_Port, ECODE_B_TIM17CH1_INPUT_CAPTURE_Pin);
