...
#define MOTOR_MAX_TRIP_STEPS_COUNT    3500////max35mm,use 32mm
...
#define ENCODER_ONE_CIRCLE_COUNT      1000//2 multiple:
#define ENCODER_MAX_COUNT      ENCODER_ONE_CIRCLE_COUNT*35//       1000*35//35mm
