...
#define MOTOR_MOVE_ERROR_TIMEOUT_S      20*SYS_1_SECOND_TICKS
#define MOTOR_MAX_TRIP_STEPS_COUNT    3400////max35mm,use 32mm
...
#define ENCODER_ONE_CIRCLE_COUNT      1000//2000//2 multiple:
#define ENCODER_MAX_COUNT      ENCODER_ONE_CIRCLE_COUNT*34//       2000*35//35mm
