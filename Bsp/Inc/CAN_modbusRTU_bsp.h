 ...
 * 非标准modbusRTU功能码
 * ************/
#define L980_MAX_MOTOR_DISTANCE_UM    34000  //32mm,最远运动距离
#define L980_DEFAULT_POSITON_UM    33000  //33mm,默认距离
#define L980_MAX_PROHOT_WAIT_TIME  20*SYS_1_SECOND_TICKS//20s、
#define L980_MOTOR_MOVE_WAIT_TIMEOUT    13*SYS_1_SECOND_TICKS//10s
